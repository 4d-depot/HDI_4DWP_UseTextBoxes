...
Insert text boxes inside [4D Write Pro](https://us.4d.com/4D-write-pro) documents (4D v19 R8) 

Find more information on the [blog post](https://blog.4d.com/4d-write-pro-say-welcome-to-floating-text-boxes/).
